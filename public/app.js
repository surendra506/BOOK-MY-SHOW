  ...
  app.innerHTML = `
    ...
    <main class="checkout-page">
      <section class="checkout-card">
        ...
        <h3>You can pick up the tickets from one of the below addresses</h3>
        <div class="address-card">
          <strong>Address 1:</strong>
          <p>Mohammedan Sporting Club, Maidan Tent, Indira Gandhi Sarani Maidan Kolkata - 700021, West Bengal, India</p>
          <p>Tue, 14 Apr 2026 - Sat, 18 Apr 2026 | 11:00 AM - 06:00 PM</p>
          <p>Sun, 19 Apr 2026 | 11:00 AM - 03:00 PM</p>
        </div>
